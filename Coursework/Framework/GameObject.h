...
public:
	...
	float findAngleTo(sf::Vector2i pointAt, sf::Vector2f myPos, bool degOrRad);
	float pointTo(sf::Vector2i mPos, sf::Vector2i winPos);
	...
	//Check what type of game object
	enum Type { PLAYER, PROJECTILE, ENEMY, WEAPON,COM,TREE };
