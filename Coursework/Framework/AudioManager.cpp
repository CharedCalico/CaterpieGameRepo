...
AudioManager::AudioManager()
{
	...
	//Add Sounds
	addSound("sfx/CollectTreat.wav","CollectTreat");
	addSound("sfx/DamageFromEnemy.wav","PlayerHit");
	addSound("sfx/Death.wav", "Death");
	addSound("sfx/DefaultShoot.wav", "DefaultShoot");
	addSound("sfx/ShotgunShoot.wav", "ShotgunShoot");
	addSound("sfx/SwordShoot.wav", "SwordShoot");
	addSound("sfx/TimerDamage.wav", "TimerDamage");

	//Add Music
	addMusic("sfx/TriggerTreatOST.wav","GameplayMusic");
	addMusic("sfx/TitleScreenOST.wav","TitleMusic");
	addSound("sfx/EnemyDeath.wav", "EnemyDeath");
}
